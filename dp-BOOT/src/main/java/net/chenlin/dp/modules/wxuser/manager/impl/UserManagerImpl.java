package net.chenlin.dp.modules.wxuser.manager.impl;
...
import net.chenlin.dp.modules.wxuser.dao.UserMapper;
import net.chenlin.dp.modules.wxuser.entity.UserEntity;
import net.chenlin.dp.modules.wxuser.manager.UserManager;
